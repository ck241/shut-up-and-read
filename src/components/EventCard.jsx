...
function EventCard({ event }) {
  ...
  return (
    <article className="group relative isolate overflow-hidden rounded-3xl border border-red-950/10 bg-white/80 p-5 shadow-lg shadow-cyan-950/5
    backdrop-blur-sm transition duration-300 hover:-translate-y-1 hover:border-sky-600/30 hover:shadow-xl hover:shadow-cyan-950/10 sm:p-6">
