...
function SignupPage(): React.JSX.Element {
  ...
  return (
    <FullLayout header="Starte deine Story hier" subheader="Willkommen">
      <form onSubmit={onSignup} className="w-full rounded-4xl border border-red-950/10 bg-white/90 p-8 shadow-2xl shadow-cyan-950/10 backdrop-blur-sm sm:p-10">
        ...
        <div className="grid gap-6">
          ...
          <p className="text-center text-sm text-stone-600">
            ...
            <Link to="/auth/login" className="font-semibold text-cyan-900 hover:text-cyan-700">
              Anmelden
            </Link>
          </p>
        </div>
